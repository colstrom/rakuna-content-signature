...
# -*- encoding: utf-8 -*-
# stub: rakuna-content-signature 1.0.1 ruby lib

Gem::Specification.new do |s|
  s.name = "rakuna-content-signature"
  s.version = "1.0.1"
  ...
  s.date = "2015-11-30"
  s.description = "Adds support for HMAC signatures with optional shared secrets to your Webmachine resources"
  ...
  s.files = [
    ...
    "rakuna-content-signature.gemspec",
    "spec/rakuna/content/signature_spec.rb",
    "spec/spec_helper.rb"
  ]
  s.homepage = "http://github.com/colstrom/rakuna-content-signature"
  s.licenses = ["MIT"]
  s.rubygems_version = "2.4.5.1"
  s.summary = "Content signatures for Rakuna and Webmachine"
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<fast_secure_compare>, ["~> 1.0"])
      s.add_runtime_dependency(%q<secure_compare>, ["~> 0.0"])
      ...
      s.add_dependency(%q<fast_secure_compare>, ["~> 1.0"])
      s.add_dependency(%q<secure_compare>, ["~> 0.0"])
